            ...
            >
                ...
                <div className="mt-8">
                    ...
                    <TextInput 
                        ...
                        value={data.name}
                        //disabled={!!group.id} //kada updateujemo grupu ne zelimo da je omoguceno promena imena
                ...
                {/*polje za biranje usera grupe */}
                <div className="mt-4">
                    <InputLabel value="Select Users" />

                    {/*users koje koristimo ovde je zapravo state koji smo gore definisali i od tih usera koje filtriramo izbacujemo id owner-a 
                    i onda samo vracamo one usere ciji je id deo data.user_ids (to su oni user_ids koje smo dobili gore u useEffect-u) */}
                    <UserPicker
                        value={
                            users.filter(
                                (u) =>
                ...
                <div className="mt-6 flex justify-end">
                    ...
                    {/*ako group_id postoji onda izbacuje opciju za update ako ne postoji onda se kreira nova grupa; takodje cemo onemoguciti ovo dugme ako je forma ima state processing */}
